...
import { MapPin, Phone, Mail, Clock, CheckCircle, MessageSquare, Users, Globe, Shield, Heart } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#002F6C]/5 via-[#00B8A9]/5 to-[#2cf4b4]/5 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gray-100 p-8 text-center">
          ...
          <h2 className="text-3xl font-bold text-[#002F6C] mb-4">Message Sent!</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Ready to revolutionize your cardiovascular screening workflow? Our team is here to help you get started with BodyCheck.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-[#002F6C]/5 to-[#00B8A9]/5 border border-[#00B8A9]/20 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-[#002F6C]">Schedule a Demo</h3>
              </div>
              <p className="text-[#002F6C] mb-6 leading-relaxed">
                Experience BodyCheck firsthand with a personalized demonstration tailored to your institution's specific needs and workflow.
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-[#002F6C]">Send us a Message</h2>
            </div>
            
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-[#002F6C] mb-1">
                    Full Name *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-[#002F6C] mb-1">
                    Email Address *
                  </label>
                  <input
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="role" className="block text-sm font-medium text-[#002F6C] mb-1">
                    Professional Role *
                  </label>
                  <select
                    id="role"
                ...
                <div>
                  <label htmlFor="organization" className="block text-sm font-medium text-[#002F6C] mb-1">
                    Organization
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-[#002F6C] mb-1">
                  Message *
                </label>
                <textarea
                  id="message"
            ...
            <div className="mt-8 text-center text-sm text-gray-500">
              By submitting this form, you agree to our <a href="/privacy" className="text-[#00B8A9] hover:text-[#002F6C]">Privacy Policy</a> and <a href="/terms" className="text-[#00B8A9] hover:text-[#002F6C]">Terms of Service</a>.
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl border border-gray-100 p-10">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-[#002F6C] mb-4">Comprehensive Support for Every Need</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From initial consultation to ongoing support, we're here to ensure your success with BodyCheck.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#002F6C] mb-3">Sales Inquiries</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#002F6C] mb-3">Technical Support</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#002F6C] mb-3">Research Partnerships</h3>
              <p className="text-gray-600 leading-relaxed">
