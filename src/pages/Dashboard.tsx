              ...
              <thead className="bg-gray-50">
                <tr>
                  {[
                    ...
                    { key: 'abdominal', label: 'Abdominal Aortic Calcification' },
                    { key: 'thoracic', label: 'Thoracic Aortic Calcification' },
                    { key: 'aorticAnnulus', label: 'Aortic Annulus Calcification' },
                    { key: 'mitralAnnulus', label: 'Mitral Annulus Calcification' },
                    { key: 'aorticValveLeaflets', label: 'Aortic Valve Leaflets Calcification' },
