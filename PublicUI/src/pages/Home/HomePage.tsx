      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            Turning routine imaging exams into early
            </p>  
            <div className="flex flex-wrap justify-center items-center gap-4 text-2xl lg:text-3xl font-medium" style={{lineHeight:"40px"}}>
              <span className="bg-gradient-to-r from-[#002F6C] to-[#00B8A9] bg-clip-text text-transparent">
              warning systems
              </span>
              <span className="text-black/60">for</span>
