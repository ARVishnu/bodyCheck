...
export const cardiovascularRows = {
  ...
  heartLength: {
    ...
    ranges: [
      ...
      { color: "#2e86e7", label: "", value: "30 cm", right: "35 cm" },
    ],
  },
  innerChestLength: {
    ...
    ranges: [
      ...
      { color: "#2e86e7", label: "", value: "35 cm", right: "" },
      { color: "#2e86e7", label: "", value: "40 cm", right: "45 cm" },
    ],
  },
  cac: {
...
export const bodyCompositionRows = {
  ...
  subcutaneousFatDensity: {
    ...
    sliderType: "linear",
    ranges: [
      { color: "#118a0f", label: "", value: "-160", right: "" },
      { color: "#ffd700", label: "", value: "-80", right: "" },
      { color: "#ff0000", label: "", value: "-40", right: "0" },
    ],
  },
  abdominalCircumference: {
    ...
    ranges: [
      ...
      { color: "#ffd700", label: "", value: "90", right: "" },
      { color: "#ff0000", label: "", value: "130", right: "170" },
    ],
  },
  liverAttenuation: {
  ...
  abdominalMuscleArea: {
    ...
    ranges: [
      { color: "#ff0000", label: "", value: "30", right: "" },
      { color: "#ffd700", label: "", value: "60", right: "" },
      { color: "#118a0f", label: "", value: "120", right: "300" },
    ],
  },
